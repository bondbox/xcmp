...
def add_cmd(_arg: argp):
    ...
    mgroup.add_argument("--same",
                        action="store_true",
                        dest="_action_same_",
                        help="Only list same files")
    mgroup.add_argument("--diff",
                        action="store_true",
                        dest="_action_diff_",
                        help="Not list same files")
